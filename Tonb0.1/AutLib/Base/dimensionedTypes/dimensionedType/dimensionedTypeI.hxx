...
template<class Type>
inline AutLib::dimensioned<Type> AutLib::dimensioned<Type>::lookupOrDefault
(
	const word & name,
...
template<class Type>
inline AutLib::dimensioned<Type> AutLib::dimensioned<Type>::lookupOrAddToDict
(
	const word & name,
	dictionary & dict,
	const Type & defaultValue,
...
template<class Type>
inline AutLib::dimensioned<Type>::dimensioned
(
	const word & name,
...
template<class Type>
inline AutLib::dimensioned<Type>::dimensioned(Istream & is)
	: name_(is)
	, dimensions_(is)
...
{
	template<class Type>
	inline dimensioned<typename dimensioned<Type>::cmptType> AutLib::dimensioned<Type>::component(const direction d) const
	{
		return dimensioned<cmptType>
			(
				name_ + ".component(" + AutLib::name(d) + ')',
				dimensions_,
				value_.component(d)
				);
	}
...
template<class Type>
inline void AutLib::dimensioned<Type>::replace(const direction d, const dimensioned<cmptType>& dc)
{
...
template<class Type>
inline bool AutLib::dimensioned<Type>::readIfPresent(const dictionary & dict)
{
...
{
	template<class Type>
	inline dimensioned<typename dimensioned<Type>::cmptType> AutLib::dimensioned<Type>::operator[](const direction d) const
	{
		return component(d);
	}

	template <class Type>
	void dimensioned<Type>::operator+=(const dimensioned<Type>& dt)
	{
		dimensions_ += dt.dimensions_;
		value_ += dt.value_;
	}
	...
	template <class Type>
	void dimensioned<Type>::operator*=(const scalar s)
	{
		value_ *= s;
	}
...
namespace AutLib
{
	...
	{
		return dimensioned<typename outerProduct<Type1, Type2>::type>
			(
				'(' + dt1.name() + "*" + dt2.name() + ')',
				dt1.dimensions() * dt2.dimensions(),
				dt1.value() * dt2.value()
	...
	{
		return dimensioned<typename outerProduct<Type, Form>::type>
			(
				'(' + dt1.name() + "*" + name(t2) + ')',
				dt1.dimensions(),
	...
	{
		return dimensioned<typename outerProduct<Form, Type>::type>
			(
				'(' + name(t1) + "*" + dt2.name() + ')',
				dt2.dimensions(),
	...
	{
		return dimensioned<typename crossProduct<Type1, Type2>::type>
			(
				'(' + dt1.name() + "^" + dt2.name() + ')',
				dt1.dimensions() ^ dt2.dimensions(),
				dt1.value() ^ dt2.value()
	...
	{
		return dimensioned<typename crossProduct<Type, Form>::type>
			(
				'(' + dt1.name() + "^" + name(t2) + ')',
				dt1.dimensions(),
				dt1.value() ^ static_cast<const Form&>(t2)
	...
	{
		return dimensioned<typename crossProduct<Form, Type>::type>
			(
				'(' + name(t1) + "^" + dt2.name() + ')',
				dt2.dimensions(),
				static_cast<const Form&>(t1) ^ dt2.value()
	...
	{
		return dimensioned<typename innerProduct<Type1, Type2>::type>
			(
				'(' + dt1.name() + "&" + dt2.name() + ')',
				dt1.dimensions() & dt2.dimensions(),
				dt1.value() & dt2.value()
	...
	{
		return dimensioned<typename innerProduct<Type, Form>::type>
			(
				'(' + dt1.name() + "&" + name(t2) + ')',
				dt1.dimensions(),
				dt1.value() & static_cast<const Form&>(t2)
	...
	{
		return dimensioned<typename innerProduct<Form, Type>::type>
			(
				'(' + name(t1) + "&" + dt2.name() + ')',
				dt2.dimensions(),
				static_cast<const Form&>(t1) & dt2.value()
	...
	{
		return dimensioned<typename scalarProduct<Type1, Type2>::type>
			(
				'(' + dt1.name() + "&&" + dt2.name() + ')',
				dt1.dimensions() && dt2.dimensions(),
				dt1.value() && dt2.value()
	...
	{
		return dimensioned<typename scalarProduct<Type, Form>::type>
			(
				'(' + dt1.name() + "&&" + name(t2) + ')',
				dt1.dimensions(),
				dt1.value() && static_cast<const Form&>(t2)
	...
	{
		return dimensioned<typename scalarProduct<Form, Type>::type>
			(
				'(' + name(t1) + "&&" + dt2.name() + ')',
				dt2.dimensions(),
				static_cast<const Form&>(t1) && dt2.value()
