...
AutLib::dimensionSet::dimensionSet(Istream& is)
{
	is >> *this;
}
...
namespace AutLib
{
	...
	Istream& AutLib::operator>>(Istream& is, dimensionSet& dset)
	{
	...
	Ostream& AutLib::operator<<(Ostream& os, const dimensionSet& dset)
	{
		os << token::BEGIN_SQR;
