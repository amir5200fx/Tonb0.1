...
namespace AutLib
{
	namespace Processor
	{
		...
		Standard_Real AutLib::Processor::SquareDistance_cgal
		(
			const Pnt3d & theQ, 
			const Pnt3d & theP0,
			const Pnt3d & theP1
		...
		Standard_Real AutLib::Processor::SquareDistanceSegments_cgal
		(
			const Pnt3d & theQ0,
			const Pnt3d & theQ1, 
			const Pnt3d & theP0,
		...
		Standard_Real AutLib::Processor::Oriented_cgal
		(
			const Pnt3d & theQ, 
			const Pnt3d & theP0, 
			const Pnt3d & theP1, 
