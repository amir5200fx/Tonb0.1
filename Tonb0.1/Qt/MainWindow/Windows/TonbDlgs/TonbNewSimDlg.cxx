...
AutLib::TonbNewSimDlg::TonbNewSimDlg(MainWindow* parent)
	: QDialog(parent)
{
	...
	setWindowIcon(QIcon(":/Menus/Icons/Menus/File/New.png"));

	setupLayout();
}

void AutLib::TonbNewSimDlg::setupLayout()
{
...
void AutLib::TonbNewSimDlg::onOK()
{
	accept();
}

void AutLib::TonbNewSimDlg::ShowParallelOptions()
{
...
void AutLib::TonbNewSimDlg::keyPressEvent(QKeyEvent * event)
{
	switch (event->key())
	{
	case Qt::Key_Escape:
